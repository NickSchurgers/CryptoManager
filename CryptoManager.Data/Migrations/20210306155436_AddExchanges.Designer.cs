...
namespace CryptoManager.Data.Migrations
{
    ...
    [Migration("20210306155436_AddExchanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoManager.Data.Models.Exchange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CryptoManager.Data.Models.Strategy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("TradingStrategy")
            ...
            modelBuilder.Entity("CryptoManager.Data.Models.Account", b =>
                {
                    b.HasOne("CryptoManager.Data.Models.Exchange", "Exchange")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("CryptoManager.Data.Models.Exchange", b =>
                {
                    b.HasOne("CryptoManager.Data.Models.Exchange", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("CryptoManager.Data.Models.Portfolio", b =>
                {
                    ...
                    b.HasOne("CryptoManager.Data.Models.Strategy", "Strategy")
                        .WithMany("Portfolios")
